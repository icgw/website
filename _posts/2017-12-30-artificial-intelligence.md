...
1. __类人行动__ ，让机器能做人类可做的事，甚至可以做得更好
2. __类人思考__ ，将人类的思考过程自动化 
3. __理性思考__ ，通过计算模型来研究智能 
4. __理性行动__ ，研究如何设计智能 Agent
...
### 类人思考：认知建模 (The cognitive modeling approach) ###
...
### 理性行动：理性 Agent (The rational agent approach)###

__Agent__ 是操纵所有计算机程序何时做何事的（有形或无形）某物。自动操作、探索环境、、适应变化、创建和追求目标。

__理性 Agent__ 要求在操作程序步骤时能实现最优化目标或最大可期望的目标。与演绎法不同，做正确的推理只是 __理性 Agent__ 的部分工作。
...
*[类人思考]: Thinking Humanly

*[理性思考]: Thinking Rationally

*[理性行动]: Acting Rationally
